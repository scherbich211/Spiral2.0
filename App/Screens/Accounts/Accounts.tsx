			...
			<View style={{ paddingTop: 30 }}>
				...
				<View style={styles.viewImages}>
					<View style={styles.viewTextImage}>
						<Image source={require('../../Assets/Images/circleButtonSend.png')} style={{ marginHorizontal: 20 }} />
						<Text style={styles.textUnderImage}>Send</Text>
					</View>
					<View style={styles.viewTextImage}>
						<Image source={require('../../Assets/Images/circleButtonPay.png')} style={{ marginHorizontal: 20 }} />
						<Text style={styles.textUnderImage}>Pay</Text>
					</View>
					<View style={styles.viewTextImage}>
						<Image source={require('../../Assets/Images/circleButtonChecking.png')} style={{ marginHorizontal: 20 }} />
